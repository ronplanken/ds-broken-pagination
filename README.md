...
If you run the paginator with the shown input, it will output the following line: `11-21 van 95 items`. Which is incorrect.
...
**Fix the paginator so it works for all pages with any given result**
